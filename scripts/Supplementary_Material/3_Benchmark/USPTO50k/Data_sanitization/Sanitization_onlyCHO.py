...
print("Sanitizing dataset for CHO reactions")
...
print("CHO reactions subset ready, number of reactinos:", len(filtered_list2))
print()

np.savetxt("Sanitized_reactions_onlyCHO.csv", filtered_list2, delimiter=", ", fmt="% s")
