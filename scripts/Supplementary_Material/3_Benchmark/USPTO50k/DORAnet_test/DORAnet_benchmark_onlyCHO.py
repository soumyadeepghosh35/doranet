...
def predictions(
    ...
    for rxn in network.rxns:
        ...
        name_value = "name"  # reaction_meta["name"]
...
print("CHO reactions reproduction rate:", correction_rate)
print("time used:", "{:.2f}".format(elapsed_time), " minutes")
print("Total doranet calls:", total_calls)
print()


f = open("Result_onlyCHO_rxns.txt", "a")

f.write("\n")
f.write("CHO reaction test result: " + str(datetime.now()))
