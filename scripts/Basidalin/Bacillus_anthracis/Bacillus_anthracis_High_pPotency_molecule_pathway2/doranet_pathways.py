...
job_name = "Bacillus_anthracis_High_pPotency_molecule_pathway2"

user_starters = {'C1=C(/C(=C\\C=O)/OC1=O)N'}

user_helpers = {'CO', 'O=O', 'O=S(=O)(O)O', 'O=C=O', '[C-]#[O+]', '[Br][Br]', 'C=C', 'O=S(O)O', 'C=O', 'Br', 'NO', 'O=[N+]([O-])O', 'O=S=O', '[H][H]', 'N#CO', 'O', 'S', 'N#N', 'N', 'C#N', 'O=NO'}

user_target = {"C=CC(=O)NC1=CC(=O)O/C1=C/C=O"}
