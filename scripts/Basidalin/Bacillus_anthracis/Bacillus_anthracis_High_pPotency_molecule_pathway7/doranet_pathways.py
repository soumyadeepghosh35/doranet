...
job_name = "Bacillus_anthracis_High_pPotency_molecule_pathway7"

user_starters = {'C1=C(/C(=C\\C=O)/OC1=O)N'}

user_helpers = {'[H][H]', 'NO', 'O=S(O)O', 'C=C', 'Br', 'O', 'O=S=O', 'O=C=O', 'C#N', 'N', 'O=O', 'S', 'C=O', 'O=S(=O)(O)O', 'O=[N+]([O-])O', 'N#CO', 'O=NO', 'N#N', 'CO', '[C-]#[O+]', '[Br][Br]'}

user_target = {"NC(=CC=O)C(C=O)=C(N)C(=O)CC=O"}
