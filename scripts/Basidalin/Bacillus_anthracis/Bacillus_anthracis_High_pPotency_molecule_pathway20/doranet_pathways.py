...
job_name = "Bacillus_anthracis_High_pPotency_molecule_pathway20"

user_starters = {'C1=C(/C(=C\\C=O)/OC1=O)N'}

user_helpers = {'Br', 'O=NO', 'O=O', 'C#N', 'S', '[C-]#[O+]', 'CO', 'N#CO', 'N#N', 'N', 'O=C=O', 'C=O', '[H][H]', 'NO', '[Br][Br]', 'O', 'O=S=O', 'O=[N+]([O-])O', 'O=S(O)O', 'C=C', 'O=S(=O)(O)O'}

user_target = {"NC(=CC(=O)Cl)C(=O)CC(=O)C(N)=CC(=O)Cl"}
