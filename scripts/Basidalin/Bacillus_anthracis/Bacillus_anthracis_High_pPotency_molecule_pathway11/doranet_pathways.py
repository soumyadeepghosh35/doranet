...
job_name = "Bacillus_anthracis_High_pPotency_molecule_pathway11"

user_starters = {'C1=C(/C(=C\\C=O)/OC1=O)N'}

user_helpers = {'O=[N+]([O-])O', 'N#CO', 'N#N', 'O=NO', 'NO', 'N', 'O=O', 'O=S(O)O', 'O=S=O', 'CO', 'O=C=O', 'C#N', 'C=O', 'O', 'C=C', '[Br][Br]', '[C-]#[O+]', 'S', '[H][H]', 'O=S(=O)(O)O', 'Br'}

user_target = {"NC1=CC(=O)OC1(N)C(C=O)C=O"}
