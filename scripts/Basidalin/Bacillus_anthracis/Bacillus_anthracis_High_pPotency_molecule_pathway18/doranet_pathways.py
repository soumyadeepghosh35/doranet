...
job_name = "Bacillus_anthracis_High_pPotency_molecule_pathway18"

user_starters = {'C1=C(/C(=C\\C=O)/OC1=O)N'}

user_helpers = {'C=O', 'C#N', 'CO', '[C-]#[O+]', 'O=C=O', 'C=C', 'O', '[Br][Br]', 'O=[N+]([O-])O', 'N#CO', 'O=O', 'O=S=O', 'O=S(=O)(O)O', 'O=NO', '[H][H]', 'O=S(O)O', 'N#N', 'S', 'N', 'Br', 'NO'}

user_target = {"NC1=CC(=O)OC1=CC=O"}
