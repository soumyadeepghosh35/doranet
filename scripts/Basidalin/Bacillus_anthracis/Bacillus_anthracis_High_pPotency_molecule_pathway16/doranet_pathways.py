...
job_name = "Bacillus_anthracis_High_pPotency_molecule_pathway16"

user_starters = {'C1=C(/C(=C\\C=O)/OC1=O)N'}

user_helpers = {'NO', 'S', 'N', 'O=S=O', 'C#N', 'N#CO', 'O=[N+]([O-])O', '[H][H]', '[C-]#[O+]', 'O=S(O)O', 'O=NO', 'O=S(=O)(O)O', 'C=C', 'O=O', 'O=C=O', 'CO', 'Br', 'C=O', 'O', '[Br][Br]', 'N#N'}

user_target = {"NCC(=O)/C=C1/OC(=O)C=C1N"}
