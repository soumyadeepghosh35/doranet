...
job_name = "Bacillus_anthracis_High_pPotency_molecule_pathway5"

user_starters = {'C1=C(/C(=C\\C=O)/OC1=O)N'}

user_helpers = {'N#N', '[H][H]', 'C#N', 'O', 'N#CO', 'Br', 'O=O', 'O=S(O)O', 'O=S(=O)(O)O', 'C=C', '[C-]#[O+]', 'NO', 'S', 'O=S=O', 'O=[N+]([O-])O', '[Br][Br]', 'O=C=O', 'CO', 'N', 'C=O', 'O=NO'}

user_target = {"NC(=O)C=C(N)C(=O)C(C=O)C=O"}
