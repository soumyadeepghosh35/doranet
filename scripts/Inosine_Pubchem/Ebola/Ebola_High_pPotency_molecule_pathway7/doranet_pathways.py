...
job_name = "Ebola_High_pPotency_molecule_pathway7"

user_starters = {'C1=NC2=C(C(=O)N1)N=CN2[C@H]3[C@@H]([C@@H]([C@H](O3)CO)O)O'}

user_helpers = {'C=C', '[C-]#[O+]', 'O=S(O)O', 'N#N', 'O=S(=O)(O)O', '[Br][Br]', 'O=[N+]([O-])O', 'O', 'NO', 'O=C=O', 'C#N', 'CO', 'O=S=O', 'S', '[H][H]', 'Br', 'O=O', 'N#CO', 'O=NO', 'N', 'C=O'}

user_target = {"*C(=O)[C@H](C)OP(=O)(O)OC[C@@H](O)[C@@H](O)[C@@H](O)Cn1c2nc(=O)[nH]c(=O)c-2cc2ccc(O)cc21"}
