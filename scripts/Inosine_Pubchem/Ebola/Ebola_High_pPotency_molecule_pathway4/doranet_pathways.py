...
job_name = "Ebola_High_pPotency_molecule_pathway4"

user_starters = {'C1=NC2=C(C(=O)N1)N=CN2[C@H]3[C@@H]([C@@H]([C@H](O3)CO)O)O'}

user_helpers = {'O=S(=O)(O)O', 'O=[N+]([O-])O', '[H][H]', 'O', 'O=S=O', 'NO', 'S', 'O=C=O', 'C#N', 'C=O', 'N#N', 'Br', '[C-]#[O+]', 'C=C', 'N#CO', 'N', 'CO', 'O=O', 'O=NO', '[Br][Br]', 'O=S(O)O'}

user_target = {"NC(=O)C1=CN([C@@H]2O[C@H](COP(=O)(O)OP(=O)(O)OC[C@H]3O[C@@H](n4cnc5c(N)ncnc54)[C@H](OP(=O)(O)O)[C@@H]3O)[C@@H](O)[C@H]2O)C=CC1"}
