...
job_name = "Ebola_High_pPotency_molecule_pathway2"

user_starters = {'C1=NC2=C(C(=O)N1)N=CN2[C@H]3[C@@H]([C@@H]([C@H](O3)CO)O)O'}

user_helpers = {'O=S(O)O', 'N#CO', 'C=C', 'O=S(=O)(O)O', 'N#N', 'O', 'CO', 'O=C=O', 'NO', '[C-]#[O+]', 'S', 'C#N', 'N', '[Br][Br]', 'C=O', '[H][H]', 'O=S=O', 'O=O', 'O=[N+]([O-])O', 'O=NO', 'Br'}

user_target = {"Cc1cc2c(cc1C)N(C[C@H](O)[C@H](O)[C@H](O)COP(=O)(O)OP(=O)(O)OC[C@H]1O[C@@H](n3cnc4c(N)ncnc43)[C@H](O)[C@@H]1O)c1[nH]c(=O)[nH]c(=O)c1N2"}
