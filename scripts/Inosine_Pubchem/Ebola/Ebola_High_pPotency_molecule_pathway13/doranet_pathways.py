...
job_name = "Ebola_High_pPotency_molecule_pathway13"

user_starters = {'C1=NC2=C(C(=O)N1)N=CN2[C@H]3[C@@H]([C@@H]([C@H](O3)CO)O)O'}

user_helpers = {'O=S(O)O', '[C-]#[O+]', 'O=C=O', '[H][H]', 'S', 'O=NO', 'O=S=O', 'Br', 'N', 'N#N', 'N#CO', 'C=C', 'O=S(=O)(O)O', 'CO', 'O=[N+]([O-])O', 'C=O', 'NO', 'C#N', '[Br][Br]', 'O', 'O=O'}

user_target = {"O=c1ccn([C@@H]2O[C@H](COP(=O)(O)OP(=O)(O)O[C@H]3O[C@H](CO)[C@@H](O)[C@H](O)[C@H]3O)[C@@H](O)[C@H]2O)c(=O)[nH]1"}
