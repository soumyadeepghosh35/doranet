...
job_name = "Ebola_High_pPotency_molecule_pathway6"

user_starters = {'C1=NC2=C(C(=O)N1)N=CN2[C@H]3[C@@H]([C@@H]([C@H](O3)CO)O)O'}

user_helpers = {'[H][H]', 'O=O', 'NO', 'O=S(=O)(O)O', 'O=NO', 'O=[N+]([O-])O', 'O=C=O', '[C-]#[O+]', 'N#N', 'N#CO', 'Br', 'S', 'N', 'O', 'C=C', 'C=O', 'C#N', '[Br][Br]', 'O=S(O)O', 'O=S=O', 'CO'}

user_target = {"*C(=O)[C@H](C)OP(=O)(O)OC[C@@H](O)[C@@H](O)[C@@H](O)CN1c2cc(O)ccc2Cc2c1[nH]c(=O)[nH]c2=O"}
