...
job_name = "Ebola_High_pPotency_molecule_pathway5"

user_starters = {'C1=NC2=C(C(=O)N1)N=CN2[C@H]3[C@@H]([C@@H]([C@H](O3)CO)O)O'}

user_helpers = {'O=NO', '[H][H]', 'N#CO', 'O=S(O)O', 'O=S(=O)(O)O', 'C#N', 'CO', '[C-]#[O+]', 'NO', 'C=C', 'O=C=O', 'Br', '[Br][Br]', 'O=[N+]([O-])O', 'C=O', 'O', 'S', 'O=S=O', 'O=O', 'N', 'N#N'}

user_target = {"Cc1cc2nc3c(=O)[nH]c(=O)nc-3n(C[C@H](O)[C@H](O)[C@H](O)COP(=O)(O)OP(=O)(O)OC[C@H]3O[C@@H](n4cnc5c(N)ncnc54)[C@H](O)[C@@H]3O)c2cc1C"}
