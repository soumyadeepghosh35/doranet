...
job_name = "Ebola_High_pPotency_molecule_pathway8"

user_starters = {'C1=NC2=C(C(=O)N1)N=CN2[C@H]3[C@@H]([C@@H]([C@H](O3)CO)O)O'}

user_helpers = {'O=NO', 'N#CO', 'CO', 'O', 'N', 'C#N', 'O=O', 'O=S=O', 'O=S(=O)(O)O', 'NO', 'O=S(O)O', 'C=O', 'O=C=O', 'N#N', 'C=C', 'S', '[Br][Br]', 'O=[N+]([O-])O', '[H][H]', 'Br', '[C-]#[O+]'}

user_target = {"*C(=O)CC[C@H](NC(=O)c1ccc(N(C=O)C[C@H]2CNc3nc(N)[nH]c(=O)c3N2)cc1)C(=O)O"}
